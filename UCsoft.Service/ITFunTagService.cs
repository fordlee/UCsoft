...
{
public  interface ITFunTagService
    {
       ...
       IEnumerable<TFunTag> GetFunTagList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TFunTag> GetFunTagList( Expression<Func<TFunTag, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TFunTag> GetFunTagList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetFunTagList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetFunTagList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetFunTagList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TFunTag GetFunTag(Expression<Func<TFunTag, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetFunTag(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        /// <param name="id">id</param>
         /// <param name="TFunTag">TFunTag</param>
        /// <returns>添加状态</returns>
        bool EditFunTag(TFunTag FunTag);
