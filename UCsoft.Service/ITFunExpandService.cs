...
{
public  interface ITFunExpandService
    {
       ...
       IEnumerable<TFunExpand> GetFunExpandList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TFunExpand> GetFunExpandList( Expression<Func<TFunExpand, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TFunExpand> GetFunExpandList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetFunExpandList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetFunExpandList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetFunExpandList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TFunExpand GetFunExpand(Expression<Func<TFunExpand, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetFunExpand(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddFunExpand(TFunExpand FunExpand);
        ...
        /// <param name="id">id</param>
         /// <param name="TFunExpand">TFunExpand</param>
        /// <returns>添加状态</returns>
        bool EditFunExpand(TFunExpand FunExpand);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteFunExpand(string ids);
