...
{
public  interface ITFunMyappService
    {
       ...
       IEnumerable<TFunMyapp> GetFunMyappList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TFunMyapp> GetFunMyappList( Expression<Func<TFunMyapp, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TFunMyapp> GetFunMyappList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetFunMyappList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetFunMyappList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetFunMyappList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TFunMyapp GetFunMyapp(Expression<Func<TFunMyapp, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetFunMyapp(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddFunMyapp(TFunMyapp FunMyapp);
        ...
        /// <param name="id">id</param>
         /// <param name="TFunMyapp">TFunMyapp</param>
        /// <returns>添加状态</returns>
        bool EditFunMyapp(TFunMyapp FunMyapp);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteFunMyapp(string ids);
