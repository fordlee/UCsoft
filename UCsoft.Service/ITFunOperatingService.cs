...
{
public  interface ITFunOperatingService
    {
       ...
       IEnumerable<TFunOperating> GetFunOperatingList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TFunOperating> GetFunOperatingList( Expression<Func<TFunOperating, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TFunOperating> GetFunOperatingList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetFunOperatingList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetFunOperatingList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetFunOperatingList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TFunOperating GetFunOperating(Expression<Func<TFunOperating, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetFunOperating(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddFunOperating(TFunOperating FunOperating);
        ...
        /// <param name="id">id</param>
         /// <param name="TFunOperating">TFunOperating</param>
        /// <returns>添加状态</returns>
        bool EditFunOperating(TFunOperating FunOperating);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteFunOperating(string ids);
