...
{
public  interface ITCusConService
    {
       ...
       IEnumerable<TCusCon> GetCusConList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TCusCon> GetCusConList( Expression<Func<TCusCon, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TCusCon> GetCusConList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetCusConList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetCusConList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetCusConList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TCusCon GetCusCon(Expression<Func<TCusCon, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetCusCon(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        /// <param name="id">id</param>
         /// <param name="TCusCon">TCusCon</param>
        /// <returns>添加状态</returns>
        bool EditCusCon(TCusCon CusCon);
