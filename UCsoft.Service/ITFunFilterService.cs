...
{
public  interface ITFunFilterService
    {
       ...
       IEnumerable<TFunFilter> GetFunFilterList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TFunFilter> GetFunFilterList( Expression<Func<TFunFilter, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TFunFilter> GetFunFilterList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetFunFilterList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetFunFilterList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetFunFilterList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TFunFilter GetFunFilter(Expression<Func<TFunFilter, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetFunFilter(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddFunFilter(TFunFilter FunFilter);
        ...
        /// <param name="id">id</param>
         /// <param name="TFunFilter">TFunFilter</param>
        /// <returns>添加状态</returns>
        bool EditFunFilter(TFunFilter FunFilter);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteFunFilter(string ids);
