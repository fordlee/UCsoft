...
public  interface ITSysRoleService
    {
       ...
       IEnumerable<TSysRole> GetSysRoleList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TSysRole> GetSysRoleList( Expression<Func<TSysRole, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TSysRole> GetSysRoleList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetSysRoleList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetSysRoleList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetSysRoleList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TSysRole GetSysRole(Expression<Func<TSysRole, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetSysRole(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddSysRole(TSysRole SysRole);
        ...
        /// <param name="id">id</param>
         /// <param name="TSysRole">TSysRole</param>
        /// <returns>添加状态</returns>
        bool EditSysRole(TSysRole SysRole);
