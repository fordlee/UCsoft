...
{
public  interface ITFunAppService
    {
       ...
       IEnumerable<TFunApp> GetFunAppList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TFunApp> GetFunAppList( Expression<Func<TFunApp, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TFunApp> GetFunAppList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetFunAppList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetFunAppList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetFunAppList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TFunApp GetFunApp(Expression<Func<TFunApp, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetFunApp(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        /// <param name="id">id</param>
         /// <param name="TFunApp">TFunApp</param>
        /// <returns>添加状态</returns>
        bool EditFunApp(TFunApp FunApp);
