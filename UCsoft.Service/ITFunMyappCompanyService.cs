...
{
public  interface ITFunMyappCompanyService
    {
       ...
       IEnumerable<TFunMyappCompany> GetFunMyappCompanyList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TFunMyappCompany> GetFunMyappCompanyList( Expression<Func<TFunMyappCompany, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TFunMyappCompany> GetFunMyappCompanyList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetFunMyappCompanyList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetFunMyappCompanyList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetFunMyappCompanyList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TFunMyappCompany GetFunMyappCompany(Expression<Func<TFunMyappCompany, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetFunMyappCompany(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddFunMyappCompany(TFunMyappCompany FunMyappCompany);
        ...
        /// <param name="id">id</param>
         /// <param name="TFunMyappCompany">TFunMyappCompany</param>
        /// <returns>添加状态</returns>
        bool EditFunMyappCompany(TFunMyappCompany FunMyappCompany);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteFunMyappCompany(string ids);
