...
{
public  interface ITSysDepartmentService
    {
       ...
       IEnumerable<TSysDepartment> GetSysDepartmentList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TSysDepartment> GetSysDepartmentList( Expression<Func<TSysDepartment, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TSysDepartment> GetSysDepartmentList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetSysDepartmentList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetSysDepartmentList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetSysDepartmentList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TSysDepartment GetSysDepartment(Expression<Func<TSysDepartment, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetSysDepartment(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddSysDepartment(TSysDepartment SysDepartment);
        ...
        /// <param name="id">id</param>
         /// <param name="TSysDepartment">TSysDepartment</param>
        /// <returns>添加状态</returns>
        bool EditSysDepartment(TSysDepartment SysDepartment);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteSysDepartment(string ids);
