...
{
public  interface ITSysPowerService
    {
       ...
       IEnumerable<TSysPower> GetSysPowerList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TSysPower> GetSysPowerList( Expression<Func<TSysPower, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TSysPower> GetSysPowerList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetSysPowerList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetSysPowerList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetSysPowerList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TSysPower GetSysPower(Expression<Func<TSysPower, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetSysPower(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddSysPower(TSysPower SysPower);
        ...
        /// <param name="id">id</param>
         /// <param name="TSysPower">TSysPower</param>
        /// <returns>添加状态</returns>
        bool EditSysPower(TSysPower SysPower);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteSysPower(string ids);
