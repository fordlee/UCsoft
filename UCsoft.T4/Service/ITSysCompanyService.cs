...
{
public  interface ITSysCompanyService
    {
       ...
       IEnumerable<TSysCompany> GetSysCompanyList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TSysCompany> GetSysCompanyList( Expression<Func<TSysCompany, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TSysCompany> GetSysCompanyList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetSysCompanyList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetSysCompanyList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetSysCompanyList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TSysCompany GetSysCompany(Expression<Func<TSysCompany, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetSysCompany(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddSysCompany(TSysCompany SysCompany);
        ...
        /// <param name="id">id</param>
         /// <param name="TSysCompany">TSysCompany</param>
        /// <returns>添加状态</returns>
        bool EditSysCompany(TSysCompany SysCompany);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteSysCompany(string ids);
