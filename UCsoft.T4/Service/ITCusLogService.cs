...
{
public  interface ITCusLogService
    {
       ...
       IEnumerable<TCusLog> GetCusLogList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TCusLog> GetCusLogList( Expression<Func<TCusLog, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TCusLog> GetCusLogList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetCusLogList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetCusLogList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetCusLogList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TCusLog GetCusLog(Expression<Func<TCusLog, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetCusLog(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        /// <param name="id">id</param>
         /// <param name="TCusLog">TCusLog</param>
        /// <returns>添加状态</returns>
        bool EditCusLog(TCusLog CusLog);
