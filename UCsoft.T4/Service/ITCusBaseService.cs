...
{
public  interface ITCusBaseService
    {
       ...
       IEnumerable<TCusBase> GetCusBaseList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TCusBase> GetCusBaseList( Expression<Func<TCusBase, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TCusBase> GetCusBaseList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetCusBaseList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetCusBaseList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetCusBaseList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TCusBase GetCusBase(Expression<Func<TCusBase, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetCusBase(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddCusBase(TCusBase CusBase);
        ...
        /// <param name="id">id</param>
         /// <param name="TCusBase">TCusBase</param>
        /// <returns>添加状态</returns>
        bool EditCusBase(TCusBase CusBase);
