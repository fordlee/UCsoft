...
public  interface ITSysUserService
    {
       ...
       IEnumerable<TSysUser> GetSysUserList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TSysUser> GetSysUserList( Expression<Func<TSysUser, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TSysUser> GetSysUserList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetSysUserList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetSysUserList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetSysUserList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TSysUser GetSysUser(Expression<Func<TSysUser, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetSysUser(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddSysUser(TSysUser SysUser);
        ...
        /// <param name="id">id</param>
         /// <param name="TSysUser">TSysUser</param>
        /// <returns>添加状态</returns>
        bool EditSysUser(TSysUser SysUser);
