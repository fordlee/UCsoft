...
public  interface ITSysLogService
    {
       ...
       IEnumerable<TSysLog> GetSysLogList();
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
       IEnumerable<TSysLog> GetSysLogList( Expression<Func<TSysLog, bool>> predicate);
        ...
        /// <param name="orders">排序字段（字段字典<字段、排序类型>）</param>
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TSysLog> GetSysLogList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetSysLogList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetSysLogList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetSysLogList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TSysLog GetSysLog(Expression<Func<TSysLog, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetSysLog(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        /// <param name="id">id</param>
         /// <param name="TSysLog">TSysLog</param>
        /// <returns>添加状态</returns>
        bool EditSysLog(TSysLog SysLog);
